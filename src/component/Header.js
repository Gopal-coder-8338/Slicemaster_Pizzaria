  ...
  return (
    <div > 
      <div className='flex w-full font-mono sm:tracking-widest items-center justify-between border-b border-stone-200
       bg-yellow-400 px-4 py-3 font-bold uppercase sm:px-6'>
        <Link to='/'>Slicemaster Pizzeria</Link>
        <div>
            <input onChange={handleSearchChange} type='search' placeholder='Search order #' className='w-28 rounded-full px-4 py-2 text-sm 
